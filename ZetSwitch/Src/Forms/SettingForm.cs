...
namespace ZetSwitch {
	public partial class SettingForm : Form, ISettingsView {
		...
		public void ResetLanguage() {
			...
			checkBoxRunAuto.Text = Language.GetText("RunAuto");
			label6.Text = Language.GetText("Language");
			buttonOk.Text = Language.GetText("Ok");
			buttonCancel.Text = Language.GetText("Cancel");
		}
